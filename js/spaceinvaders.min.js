...
}function Ship(t,e){this.x=t,this.y=e,this.width=20,this.height=16}function Rocket(t,e,i){this.x=t,this.y=e,this.velocity=i}function Bomb(t,e,i){this.x=t,this.y=e,
...
this.enter=o,this.leave=h}function Sounds(){this.audioContext=null,this.sounds={}}Game.prototype.initialise=function(t){this.gameCanvas=t,this.width=t.width,this.height=t.height,
...
}var h=!1,n=!1,a=!1;for(i=0;i<this.invaders.length;i++){var r=this.invaders[i],l=r.x+this.invaderVelocity.x*e,c=r.y+this.invaderVelocity.y*e;h===!1&&l<t.gameBounds.left?h=!0:n===!1&&l>t.gameBounds.right?n=!0:a===!1&&c>t.gameBounds.bottom&&(a=!0),
h||n||a||(r.x=l,r.y=c)}for(this.invadersAreDropping&&(this.invaderCurrentDropDistance+=this.invaderVelocity.y*e,this.invaderCurrentDropDistance>=this.config.invaderDropDistance&&(this.invadersAreDropping=!1,
...
this.boss.x<200&&(this.boss.movedirection=-1),this.boss.x=this.boss.x-e*this.boss.movedirection*30,a&&(this.lives=0),i=0;i<this.invaders.length;i++){for(var r=this.invaders[i],d=!1,f=0;f<this.rockets.length;f++){
var o=this.rockets[f];if(o.x>=r.x-r.width/2&&o.x<=r.x+r.width/2&&o.y>=r.y-r.height/2&&o.y<=r.y+r.height/2){this.rockets.splice(f--,1),d=!0,t.score+=this.config.pointsPerInvader;
break}}d&&(this.invaders.splice(i--,1),t.sounds.playSound("bang"))}for(var u=this.boss,p=!1,f=0;f<this.rockets.length;f++){var o=this.rockets[f];if(o.x>=u.x-u.width/2&&o.x<=u.x+u.width/2&&o.y>=u.y-u.height/2&&o.y<=u.y+u.height/2){
this.rockets.splice(f--,1),p=!0,t.score+=this.config.pointsPerInvader;break}}p&&(this.boss.hp=this.boss.hp-20,0===this.boss.hp,t.sounds.playSound("bang"));for(var g={},i=0;i<this.invaders.length;i++){
...
i.fillStyle="#006600";for(var s=0;s<this.invaders.length;s++){var o=this.invaders[s];i.fillText("Test",o.x,o.y),i.fillRect(o.x-o.width/2,o.y-o.height/2,o.width,o.height);
}i.fillStyle="#008800";var h=this.boss;i.fillRect(h.x-h.width/2,h.y-h.height/2,h.width,h.height),console.log(h),i.fillStyle="#ff5555";for(var s=0;s<this.bombs.length;s++){
var n=this.bombs[s];i.fillRect(n.x-2,n.y-2,4,4)}i.fillStyle="#ff0000";for(var s=0;s<this.rockets.length;s++){var a=this.rockets[s];i.fillRect(a.x,a.y-2,1,4)}var r=t.gameBounds.bottom+(t.height-t.gameBounds.bottom)/2+7;
