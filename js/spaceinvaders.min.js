...
this.keyboard=t},GameImages.prototype.keycaps=function(){var t=Object(this),e=[];t.keycapList.map(function(t,i){var s=new Image;s.src="data:image/png;base64,"+t,
e.push(s)}),this.keycaps=e};var gameImages=new GameImages;gameImages.keyboard(),gameImages.keycaps(),Game.prototype.initialise=function(t){this.gameCanvas=t,this.width=t.width,
