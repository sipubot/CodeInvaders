...
this.rockets=[],this.bombs=[],this.boss={},this.bossbombs=[]}function PauseState(){}function LevelIntroState(t){this.level=t,this.countdownMessage="3",this.IntroStageWord="This is Just Game";
...
this.velocity=i}function BossBomb(t,e,i,s){this.x=t,this.y=e,this.direction=i,this.velocity=s}function Invader(t,e,i,s,o){this.x=t,this.y=e,this.rank=i,this.file=s,
this.type=o,this.width=18,this.height=14}function Boss(t,e,i){this.x=t,this.y=e,this.stage=i,this.hp=1e3,this.movedirection=-1,this.width=80,this.height=40}function GameState(t,e,i,s,o,n){
this.updateProc=t,this.drawProc=e,this.keyDown=i,this.keyUp=s,this.enter=o,this.leave=n}function Sounds(){this.audioContext=null,this.sounds={}}GameImages.prototype.keyboard=function(){
...
this.stateStack.pop()),t.enter&&t.enter(game),this.stateStack.pop(),this.stateStack.push(t)},Game.prototype.start=function(){this.moveToState(new WelcomeState),this.lives=3,
this.config.debugMode=/debug=true/.test(window.location.href);var t=this;this.intervalId=setInterval(function(){GameLoop(t)},1e3/this.config.fps)},Game.prototype.currentState=function(){
return this.stateStack.length>0?this.stateStack[this.stateStack.length-1]:null},Game.prototype.mute=function(t){t===!0?this.sounds.mute=!0:t===!1?this.sounds.mute=!1:this.sounds.mute=!this.sounds.mute;
},Game.prototype.pushState=function(t){t.enter&&t.enter(game),this.stateStack.push(t)},Game.prototype.popState=function(){this.currentState()&&(this.currentState().leave&&this.currentState().leave(game),
...
this.boss=a},PlayState.prototype.update=function(t,e){var i=Object(this);t.pressedKeys[37]&&(this.ship.x-=this.shipSpeed*e),t.pressedKeys[39]&&(this.ship.x+=this.shipSpeed*e),
...
});var s=!1,o=!1,n=!1;this.invaders.map(function(h){var a=h.x+i.invaderVelocity.x*e,r=h.y+i.invaderVelocity.y*e;s===!1&&a<t.gameBounds.left?s=!0:o===!1&&a>t.gameBounds.right?o=!0:n===!1&&r>t.gameBounds.bottom&&(n=!0),
s||o||n||(h.x=a,h.y=r)}),this.invadersAreDropping&&(this.invaderCurrentDropDistance+=this.invaderVelocity.y*e,this.invaderCurrentDropDistance>=this.config.invaderDropDistance&&(this.invadersAreDropping=!1,
this.invaderVelocity=this.invaderNextVelocity,this.invaderCurrentDropDistance=0)),s&&(this.invaderCurrentVelocity+=this.config.invaderAcceleration,this.invaderVelocity={
x:0,y:this.invaderCurrentVelocity},this.invadersAreDropping=!0,this.invaderNextVelocity={x:this.invaderCurrentVelocity,y:0}),o&&(this.invaderCurrentVelocity+=this.config.invaderAcceleration,
...
this.boss.x<200&&(this.boss.movedirection=-1),this.boss.x=this.boss.x-e*this.boss.movedirection*30,this.bossbombs.map(function(s,o){switch(s.direction){case 0:s.y+=e*s.velocity,
s.x-=e*s.velocity;break;case 1:s.y+=e*s.velocity;break;case 2:s.y+=e*s.velocity,s.x+=e*s.velocity}(s.y>t.height||s.x>t.width||s.x<0||s.y<0)&&i.bossbombs.splice(o--,1);
}),n&&(this.lives=0),this.invaders.map(function(e,s){var o=!1;i.rockets.map(function(s,n){s.x>=e.x-e.width/2&&s.x<=e.x+e.width/2&&s.y>=e.y-e.height/2&&s.y<=e.y+e.height/2&&(i.rockets.splice(n--,1),
...
a=!0,t.score+=i.config.pointsPerInvader)}),a&&(this.boss.hp=i.boss.hp-20,0===i.boss.hp,t.sounds.playSound("bang")),i.boss.hp>0&&0===i.bossbombs.length&&(i.bossbombs.push(new BossBomb(i.boss.x,i.boss.y+i.boss.height/2,0,i.bombMinVelocity+Math.random()*(i.bombMaxVelocity-i.bombMinVelocity))),
...
var r={};this.invaders.map(function(t){(!r[t.file]||r[t.file].rank<t.rank)&&(r[t.file]=t)}),Object.keys(r).map(function(t,s){var o=i.bombRate*e;o>Math.random()&&i.bombs.push(new Bomb(r[t].x,r[t].y+r[t].height/2,i.bombMinVelocity+Math.random()*(i.bombMaxVelocity-i.bombMinVelocity)));
...
t.lives--,t.sounds.playSound("explosion"))}),this.bossbombs.map(function(e,s){e.x>=i.ship.x-i.ship.width/2&&e.x<=i.ship.x+i.ship.width/2&&e.y>=i.ship.y-i.ship.height/2&&e.y<=i.ship.y+i.ship.height/2&&(i.bossbombs.splice(s--,1),
t.lives--,t.sounds.playSound("explosion"))}),this.invaders.map(function(e){e.x+e.width/2>i.ship.x-i.ship.width/2&&e.x-e.width/2<i.ship.x+i.ship.width/2&&e.y+e.height/2>i.ship.y-i.ship.height/2&&e.y-e.height/2<i.ship.y+i.ship.height/2&&(t.lives=0,
t.sounds.playSound("explosion"))}),t.lives<=0&&t.moveToState(new GameOverState),0===i.invaders.length&&0===i.boss.hp&&(t.score+=50*i.level,t.level+=1,t.moveToState(new LevelIntroState(t.level)));
},PlayState.prototype.draw=function(t,e,i){Object(this);i.clearRect(0,0,t.width,t.height),i.fillStyle="#999999",i.fillRect(this.ship.x-this.ship.width/2,this.ship.y-this.ship.height/2,this.ship.width,this.ship.height),
...
i.fillRect(t.x-t.width/2,t.y-t.height/2,t.width,t.height)});var s=this.boss;i.fillStyle="#ff"+Math.floor(s.hp/11).toString()+"11",i.fillRect(s.x-s.width/2,s.y-s.height/2,s.width,s.height),
i.fillStyle="#00ffff",this.bossbombs.map(function(t){i.fillRect(t.x-2,t.y-2,6,6)}),i.fillStyle="#ff5555",this.bombs.map(function(t){i.fillRect(t.x-2,t.y-2,4,4)}),
i.fillStyle="#ff0000",this.rockets.map(function(t){i.fillRect(t.x,t.y-2,8,8),i.drawImage(gameImages.keycaps[0],t.x,t.y-2,8,8)});var o=t.gameBounds.bottom+(t.height-t.gameBounds.bottom)/2+7;
i.font="14px Arial",i.fillStyle="#ffffff";var n="Lives: "+t.lives;i.textAlign="left",i.fillText(n,t.gameBounds.left,o),n="Score: "+t.score+", Level: "+t.level,i.textAlign="right",
i.fillText(n,t.gameBounds.right,o),this.config.debugMode&&(i.strokeStyle="#ff0000",i.strokeRect(0,0,t.width,t.height),i.strokeRect(t.gameBounds.left,t.gameBounds.top,t.gameBounds.right-t.gameBounds.left,t.gameBounds.bottom-t.gameBounds.top));
