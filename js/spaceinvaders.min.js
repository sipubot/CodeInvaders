...
}),this.bombs.map(function(e){e.x>=i.ship.x-i.ship.width/2&&e.x<=i.ship.x+i.ship.width/2&&e.y>=i.ship.y-i.ship.height/2&&e.y<=i.ship.y+i.ship.height/2&&(i.bombs.splice(ibs--,1),
