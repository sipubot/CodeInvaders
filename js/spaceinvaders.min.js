...
this.keyboard=t},GameImages.prototype.keycaps=function(){var t=Object(this);this.keycaps=[this.keycapList.length],this.keycaps.map(function(e,i){e=new Image,e={},
e.src="data:image/png;base64,"+t.keycapList[i]})};var gameImages=new GameImages;gameImages.keyboard(),gameImages.keycaps(),Game.prototype.initialise=function(t){
...
this.boss.x<200&&(this.boss.movedirection=-1),this.boss.x=this.boss.x-e*this.boss.movedirection*30,n&&(this.lives=0),this.invaders.map(function(e,s){var o=!1;i.rockets.map(function(s,n){
...
t.sounds.playSound("bang"))});var h=i.boss,a=!1;this.rockets.map(function(e,s){e.x>=h.x-h.width/2&&e.x<=h.x+h.width/2&&e.y>=h.y-h.height/2&&e.y<=h.y+h.height/2&&(i.rockets.splice(s--,1),
a=!0,t.score+=i.config.pointsPerInvader)}),a&&(this.boss.hp=i.boss.hp-20,0===i.boss.hp,t.sounds.playSound("bang"));var r={};this.invaders.map(function(t){(!r[t.file]||r[t.file].rank<t.rank)&&(r[t.file]=t);
}),Object.keys(r).map(function(t,s){var o=i.bombRate*e;o>Math.random()&&i.bombs.push(new Bomb(r[t].x,r[t].y+r[t].height/2,i.bombMinVelocity+Math.random()*(i.bombMaxVelocity-i.bombMinVelocity)));
...
this.bombs.map(function(t){i.fillRect(t.x-2,t.y-2,4,4)}),i.fillStyle="#ff0000",this.rockets.map(function(t){console.log(t),i.fillRect(t.x,t.y-2,8,8),i.drawImage(gameImages.keycapList[0],t.x,t.y-2,8,8);
