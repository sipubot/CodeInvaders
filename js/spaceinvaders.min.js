...
function LevelIntroState(t){this.level=t,this.countdownMessage="3"}function Ship(t,e){this.x=t,this.y=e,this.width=20,this.height=16}function Rocket(t,e,i){this.x=t,
this.y=e,this.velocity=i}function Bomb(t,e,i){this.x=t,this.y=e,this.velocity=i}function Invader(t,e,i,s,o){this.x=t,this.y=e,this.rank=i,this.file=s,this.type=o,
this.width=18,this.height=14}function GameState(t,e,i,s,o,n){this.updateProc=t,this.drawProc=e,this.keyDown=i,this.keyUp=s,this.enter=o,this.leave=n}function Sounds(){
...
this.countdown<=0&&t.moveToState(new PlayState(t.config,this.level))},LevelIntroState.prototype.draw=function(t,e,i){i.clearRect(0,0,t.width,t.height),t.backgroundScreen.drawStageIntro(),
...
i.font="24px Arial",i.fillText("Ready in "+this.countdownMessage,t.width/2,t.height/2+36),t.backgroundScreen.fps=60},Sounds.prototype.init=function(){context=window.AudioContext||window.webkitAudioContext,
