...
this.keyboard=t},GameImages.prototype.keycaps=function(){this.keycaps=[this.keycapList.length],this.keycaps.map(function(t,e){t=new Image,t.src="data:image/png;base64,"+this.keycapList[e];
})};var gameImages=new GameImages;gameImages.keyboard(),gameImages.keycaps(),Game.prototype.initialise=function(t){this.gameCanvas=t,this.width=t.width,this.height=t.height,
