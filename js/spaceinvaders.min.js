...
this.x=t,this.y=e,this.rank=i,this.file=s,this.type=o,this.width=18,this.height=14}function Boss(t,e,i){this.x=t,this.y=e,this.stage=i,this.hp=1e3,this.width=80,
this.height=40}function GameState(t,e,i,s,o,n){this.updateProc=t,this.drawProc=e,this.keyDown=i,this.keyUp=s,this.enter=o,this.leave=n}function Sounds(){this.audioContext=null,
...
this.invaders=o,this.invaderCurrentVelocity=this.invaderInitialVelocity,this.invaderVelocity={x:-this.invaderInitialVelocity,y:0},this.invaderNextVelocity=null;var a=new Boss(t.width/2,0,t.stage);
