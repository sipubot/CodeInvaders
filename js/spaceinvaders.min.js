...
i.fillRect(t.x-t.width/2,t.y-t.height/2,t.width,t.height)}),i.fillStyle="#008800";var s=this.boss;i.fillRect(s.x-s.width/2,s.y-s.height/2,s.width,s.height),i.fillStyle="#00ffff",
this.bossbombs.map(function(t){i.fillRect(t.x-2,t.y-2,6,6)}),i.fillStyle="#ff5555",this.bombs.map(function(t){i.fillRect(t.x-2,t.y-2,4,4)}),i.fillStyle="#ff0000",
this.rockets.map(function(t){i.fillRect(t.x,t.y-2,8,8),i.drawImage(gameImages.keycaps[0],t.x,t.y-2,8,8)});var o=t.gameBounds.bottom+(t.height-t.gameBounds.bottom)/2+7;
