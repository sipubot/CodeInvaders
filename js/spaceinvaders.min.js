...
this.y=e,this.velocity=i}function Bomb(t,e,i){this.x=t,this.y=e,this.velocity=i}function BossBomb(t,e,i,s){this.x=t,this.y=e,this.direction=i,this.velocity=s,this.bombMove=function(t,e){
switch(this.direction){case 0:this.x-=t*this.velocity,this.y+=t*this.velocity;break;case 1:this.y+=t*this.velocity;break;case 2:this.y+=t*this.velocity,this.x+=t*this.velocity;
}}}function ExplosionBoss(t,e,i,s){this.x=t,this.y=e,this.direction=i,this.velocity=s}function Invader(t,e,i,s,o){this.x=t,this.y=e,this.rank=i,this.file=s,this.type=o,
this.width=18,this.height=14}function Boss(t,e,i){this.x=t,this.y=e,this.stage=i,this.hp=1e3,this.movedirection=-1,this.width=80,this.height=40,this.bossbombsshot=function(t,e,i,s){
var o=[];return o.push(new BossBomb(t,e,0,i)),o.push(new BossBomb(t,e,1,i)),o.push(new BossBomb(t,e,2,i)),o}}function GameState(t,e,i,s,o,n){this.updateProc=t,this.drawProc=e,
this.keyDown=i,this.keyUp=s,this.enter=o,this.leave=n}function Sounds(){this.audioContext=null,this.sounds={}}GameImages.prototype.keyboard=function(){var t=new Image;
t.src="data:image/png;base64,"+this.keyboardImageCode,this.keyboard=t},GameImages.prototype.keycaps=function(){var t=Object(this),e=[];t.keycapList.forEach(function(t,i){
...
t.stageName.forEach(function(e,s){t.stage===s?(i.strokeStyle="#ffffff",i.fillStyle="#ffffff"):(i.strokeStyle="#999999",i.fillStyle="#999999"),i.strokeRect(t.width/2-255+130*s,t.height/2+300,120,60),
...
this.bombs.forEach(function(t,s){t.y+=e*t.velocity,t.y>i.height&&i.bombs.splice(s--,1)}),this.rockets.forEach(function(t,s){t.y-=e*t.velocity,t.y<0&&i.rockets.splice(s--,1);
});var s=!1,o=!1,n=!1;this.invaders.forEach(function(h){var a=h.x+i.invaderVelocity.x*e,l=h.y+i.invaderVelocity.y*e;s===!1&&a<t.gameBounds.left?s=!0:o===!1&&a>t.gameBounds.right?o=!0:n===!1&&l>t.gameBounds.bottom&&(n=!0),
...
this.bossbombs.forEach(function(s,o){s.bombMove(e,t.stage),(s.y>t.height||s.x>t.width||s.x<0||s.y<0)&&i.bossbombs.splice(o--,1)}),this.bossexplosion.forEach(function(t,i){
switch(t.direction){case 0:t.y+=e*t.velocity,t.x-=e*t.velocity;break;case 1:t.y+=e*t.velocity;break;case 2:t.y+=e*t.velocity,t.x+=e*t.velocity;break;case 3:t.y-=e*t.velocity,
t.x-=e*t.velocity;break;case 4:t.y-=e*t.velocity;break;case 5:t.y-=e*t.velocity,t.x+=e*t.velocity}}),this.invaders.forEach(function(e,s){var o=!1;i.rockets.forEach(function(s,n){
s.x>=e.x-e.width/2&&s.x<=e.x+e.width/2&&s.y>=e.y-e.height/2&&s.y<=e.y+e.height/2&&(i.rockets.splice(n--,1),o=!0,t.score+=i.config.pointsPerInvader)}),o&&(i.invaders.splice(s--,1),
t.sounds.playSound("bang"))});var h=i.boss,a=!1;this.rockets.forEach(function(e,s){e.x>=h.x-h.width/2&&e.x<=h.x+h.width/2&&e.y>=h.y-h.height/2&&e.y<=h.y+h.height/2&&(i.rockets.splice(s--,1),
a=!0,t.score+=i.config.pointsPerInvader)}),a&&(this.boss.hp=i.boss.hp-20,i.boss.hp<0&&(this.boss.hp=0),t.sounds.playSound("bang")),i.boss.hp>0&&0===i.bossbombs.length&&(i.bossbombs=i.boss.bossbombsshot(i.boss.x,i.boss.y+i.boss.height/2,i.bombMinVelocity+Math.random()*(i.bombMaxVelocity-i.bombMinVelocity)*5));
var l={};if(this.invaders.forEach(function(t){(!l[t.file]||l[t.file].rank<t.rank)&&(l[t.file]=t)}),Object.keys(l).forEach(function(t,s){var o=i.bombRate*e;o>Math.random()&&i.bombs.push(new Bomb(l[t].x,l[t].y+l[t].height/2,i.bombMinVelocity+Math.random()*(i.bombMaxVelocity-i.bombMinVelocity)));
}),this.bombs.forEach(function(e,s){e.x>=i.ship.x-i.ship.width/2&&e.x<=i.ship.x+i.ship.width/2&&e.y>=i.ship.y-i.ship.height/2&&e.y<=i.ship.y+i.ship.height/2&&(i.bombs.splice(s--,1),
i.ship.hp--,t.sounds.playSound("explosion"))}),this.bossbombs.forEach(function(e,s){e.x>=i.ship.x-i.ship.width/2&&e.x<=i.ship.x+i.ship.width/2&&e.y>=i.ship.y-i.ship.height/2&&e.y<=i.ship.y+i.ship.height/2&&(i.bossbombs.splice(s--,1),
...
i.drawImage(gameImages.keyboard,this.ship.x-this.ship.width/2,this.ship.y-this.ship.height/2,80,42),i.fillStyle="#006600",this.invaders.forEach(function(t){i.fillText("Test",t.x,t.y),
...
i.fillStyle="#00ffff",this.bossbombs.forEach(function(t){i.fillRect(t.x-2,t.y-2,6,6)}),i.fillStyle="#00ffff",this.bossexplosion.forEach(function(t){i.fillRect(t.x-2,t.y-2,20,10);
}),i.fillStyle="#ff5555",this.bombs.forEach(function(t){i.fillRect(t.x-2,t.y-2,4,4)}),i.fillStyle="#ff0000",this.rockets.forEach(function(t){i.fillRect(t.x,t.y-2,8,8),
i.drawImage(gameImages.keycaps[0],t.x,t.y-2,8,8)});var n=t.gameBounds.bottom+(t.height-t.gameBounds.bottom)/2+7;i.fillStyle="#dddddd",i.strokeRect(t.gameBounds.left,n-1,2*s.ship.inithp,7),
i.fillStyle="rgb(255,"+2*s.ship.hp+",0)",i.fillRect(t.gameBounds.left,n,2*s.ship.hp,5),i.fillStyle="#ffffff",i.font="14px Arial",info="Score: "+t.score+", Level: "+t.level,
i.textAlign="right",i.fillText(info,t.gameBounds.right,n),this.config.debugMode&&(i.strokeStyle="#ff0000",i.strokeRect(0,0,t.width,t.height),i.strokeRect(t.gameBounds.left,t.gameBounds.top,t.gameBounds.right-t.gameBounds.left,t.gameBounds.bottom-t.gameBounds.top));
